type Pipe = {
  ...
  <
    T1 extends (...args: any) => any,
    T2 extends (
      arg: ReturnType<T1> extends Promise<infer T1> ? T1 : ReturnType<T1>
    ) => any,
    T3 extends (
      arg: ReturnType<T2> extends Promise<infer T2> ? T2 : ReturnType<T2>
    ) => any
  >(
    fn1: T1,
    fn2: T2,
  ...
  <
    ...
    T4 extends (
      arg: ReturnType<T3> extends Promise<infer T3> ? T3 : ReturnType<T3>
    ) => any
  >(
    fn1: T1,
    fn2: T2,
  ...
  <
    ...
    T5 extends (
      arg: ReturnType<T4> extends Promise<infer T4> ? T4 : ReturnType<T4>
    ) => any
  >(
    fn1: T1,
    fn2: T2,
